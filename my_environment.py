...
#         print(np.array([a['res_price'] for a in self.sellers] + [0.0] * self.n_buyers))
#         print(np.array([np.infty] * self.n_sellers + [a['res_price'] for a in self.buyers]))
