...
loop over bunches of games:
    - make changes to agents, create/kill agents, update n_sellers, n_buyers
    - define parameters of the game (max_time, matcher) and create an environment
    ...
    - data about the current bunch of games is collected and averaged
